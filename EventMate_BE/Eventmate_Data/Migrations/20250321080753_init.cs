    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OTPAuthen", x => x.OTPId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizerLogo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrganizerDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    banner = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BannerStatus = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Multimedia", x => x.ImageId);
                    table.ForeignKey(
                        name: "FK_Multimedia_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "AlbumId");
                    table.ForeignKey(
                        name: "FK_Multimedia_User_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MultimediaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteMedia", x => new { x.MultimediaId, x.UserId });
                    table.ForeignKey(
                        name: "FK_FavoriteMedia_Multimedia_MultimediaId",
                        column: x => x.MultimediaId,
                        principalTable: "Multimedia",
                        principalColumn: "ImageId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FavoriteMedia_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cost_Activity_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activity",
                        principalColumn: "ActivityId");
                    table.ForeignKey(
                        name: "FK_Cost_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "GroupId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cost_User_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cost_ActivityId",
                table: "Cost",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_Cost_CreatedBy",
                table: "Cost",
                column: "CreatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Multimedia_AlbumId",
                table: "Multimedia",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_Multimedia_CreatedBy",
                table: "Multimedia",
                column: "CreatedBy");
